...
int sp_ecc_mulmod_brainpool_256(mp_int* km, ecc_point* gm, ecc_point* rm, int map,
                          void* heap);
int sp_ecc_mulmod_base_brainpool_256(mp_int* km, ecc_point* rm, int map, void* heap);
...
WOLFSSL_LOCAL int sp_ecc_cache_verify_brainpool_256(const byte* hash,
                      ...
                      mp_int* r, mp_int* sm, int* rs, sp_cache_256_t* cache,
                      void* heap);
#endif
