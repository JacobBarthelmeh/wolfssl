...
struct wc_Sha256 {
    ...
    ALIGN16 word32  digest[(unsigned)WC_SHA256_DIGEST_SIZE / sizeof(word32)];
    ALIGN16 word32  buffer[(unsigned)WC_SHA256_BLOCK_SIZE  / sizeof(word32)];
...
#ifdef WOLFSSL_PIC32MZ_HASH
WOLFSSL_API void wc_Sha256SizeSet(wc_Sha256* sha256, word32 size);
#endif
...
WOLFSSL_API int wc_InitSha224_ex(wc_Sha224* sha225, void* heap, int devId);
