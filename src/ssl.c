...
static void ExternalFreeX509(WOLFSSL_X509* x509)
{
    ...
    /* Retruns the string length, not including the null terminator */
                                          ...
                                          int nid, char* buf, int len)
    {
        ...
        if (textSz == 0) {
            WOLFSSL_MSG("No entry with NID type");
            return -1;
        }

        if (buf != NULL && text != NULL) {
            textSz = min(textSz + 1, len); /* plus one for null terminator */
            if (textSz > 0) {
        ...
        return (textSz - 1); /* do not include null terminator in length */
    }
...
WOLFSSL_EVP_PKEY* wolfSSL_PKEY_new_ex(void* heap)
{
    ...
    if (pkey != NULL) {
        ...
        ret = wc_InitRng_ex(&(pkey->rng), heap, 0);
        if (ret != 0){
            wolfSSL_EVP_PKEY_free(pkey);
...
WOLFSSL_API long wolfSSL_set_tlsext_status_type(WOLFSSL *s, int type)
{
    (void)s;
    (void)type;
    WOLFSSL_STUB("SSL_set_tlsext_status_type");
    return 0;
}
#endif
...
WOLFSSL_API long wolfSSL_get_tlsext_status_exts(WOLFSSL *s, void *arg)
{
    (void)s;
    (void)arg;
    WOLFSSL_STUB("SSL_get_tlsext_status_exts");
    return 0;
}
#endif
...
WOLFSSL_API long wolfSSL_set_tlsext_status_exts(WOLFSSL *s, void *arg)
{
    (void)s;
    (void)arg;
    WOLFSSL_STUB("SSL_set_tlsext_status_exts");
    return 0;
}
#endif
...
WOLFSSL_API long wolfSSL_get_tlsext_status_ids(WOLFSSL *s, void *arg)
{
    (void)s;
    (void)arg;
    WOLFSSL_STUB("SSL_get_tlsext_status_ids");
    return 0;
}
#endif
...
WOLFSSL_API long wolfSSL_set_tlsext_status_ids(WOLFSSL *s, void *arg)
{
    (void)s;
    (void)arg;
    WOLFSSL_STUB("SSL_set_tlsext_status_ids");
    return 0;
}
#endif
...
int wolfSSL_RAND_egd(const char* nm)
{
    ...
    if (bytes > 0 && ret == SSL_SUCCESS) {
        ...
        if (Hash_DRBG_Reseed(globalRNG.drbg, (const byte*) buf, bytes)
                != 0) {
...
/* needed SetName function from asn.c is wrapped by NO_RSA */
    ...
    int wolfSSL_BIO_read_filename(WOLFSSL_BIO *b, const char *name) {
        ...
        WOLFSSL_STUB("BIO_read_filename");
...
int wolfSSL_PEM_write_bio_X509_REQ(WOLFSSL_BIO *bp, WOLFSSL_X509 *x)
{
    ...
    if (pemSz < 0) {
        #ifdef WOLFSSL_SMALL_STACK
            XFREE((unsigned char*)der, NULL, DYNAMIC_TYPE_TMP_BUFFER);
        #endif
        return SSL_FAILURE;
    }
...
STACK_OF(WOLFSSL_X509)* wolfSSL_get_peer_cert_chain(const WOLFSSL* ssl)
{
    ...
    WOLFSSL_STUB("SSL_get_peer_cert_chain");
